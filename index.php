...
<body>
    ...
    <header>
        <div class="top-bar">
            ...
            <h1 class="title-page">Privacy & Termini</h1>
        </div>
        <div class="container-menu">
            <ul class="main-menu">
                <li class="menu-item"><a href="#">Introduzione</a></li>
                <li class="menu-item"><a href="#">Norme sulla privacy</a></li>
                <li class="menu-item"><a href="#">Termini di servizi</a></li>
                <li class="menu-item"><a href="#">Tecnologie</a></li>
                <li class="menu-item active"><a href="#">Domande frequenti</a></li>
            </ul>
        </div>
    </header>
    ...
    foreach ($faq as $value) { ?>
        <h2 class="question-faq"> <?php echo $value['question'] ?> </h2>
        <?php for ($i=0; $i < count($value['answers']); $i++) { ?>
        <p class="answer-faq">
